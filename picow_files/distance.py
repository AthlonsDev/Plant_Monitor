...
trigger = Pin(22, Pin.OUT) #obj corresponding to pin 22 on trigger, This will send pulse of current
echo = Pin(21, Pin.IN) #obj corresponding to pin 21 on echo, this will receive reflected pulse
